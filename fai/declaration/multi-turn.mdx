...
- Multi-turn: this means this agent is expecting where available, a history of previous requests for the 'same task' at hand
...
In the first turn a new, `gen_thread_id`. You can see this as a new multi-turn conversation.

And then when running this locally
...
- this probably handles for multi-turn llm interactions. option question on whether all of them should 'always' be optionally previous, probably not?